                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_mapel" name="id_mapel[]" style="width: 100%;" multiple="multiple" data-placeholder="Pilih Matapelajaran" >
                                <?php echo $mapel?>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
  ...
  // My Datatables
  var   urlDb   = "<?php echo base_url('kbm/showMapelTingkat')?>";
  var   totalClmn;
  var   table1;
  $(document).ready(function() {
    ...
    function show_modal(data) {
        ...
        if (mode == "add") {
            ...
            $.ajax({
                url : "<?php echo base_url('kbm/mapelTingkatAction')?>/"+"detail",
                dataType: "json",
