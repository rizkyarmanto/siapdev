    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-sm-6">
        <div class="box box-danger">
              <div class="box-header with-border">
                <h3 class="box-title">Data Rekap Nilai</h3>
              </div>
            ...
            <div class="box box-danger">
                <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-flat clicksubmit"><i class="fa fa-send"></i> Cetak</button>
...
<script type="text/javascript">
  ...
  $(document).on('click', ".get-data-kelas", function() {
    ...
    var loading = '<tr><td colspan="5"><h5 class="text-center"><i>Loading . . . </i></h5></td></tr>';
    var nothing = '<tr><td colspan="5"><h5 class="text-center"><i>Tidak ada data !</i></h5></td></tr>';
    $(document).find('#data-tarif').load().html(loading);
    var url_control = base_url+"nilai/get_rekap_nilai";
