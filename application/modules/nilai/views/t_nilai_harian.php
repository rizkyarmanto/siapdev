...
<div class="container">
  ...
  <section class="content">
    ...
    <!-- Box -->
    <form id="form-transaksi" action="<?php echo base_url('nilai/input_nilai_harian')?>" method="post">
      <div class="col-lg-12 col-sm-6">
        <div class="box box-danger">
              <div class="box-header with-border">
                <h3 class="box-title">Form Data Nilai Harian</h3>
              </div>
            ...
            <div class="box box-danger" id="div-cetak">
                <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-flat clicksubmit"><i class="fa fa-save"></i> Simpan</button>
...
<script type="text/javascript">
  ...
  $(document).on('click', ".get-data-kelas", function() {
    ...
    var loading = '<tr><td colspan="20"><h5 class="text-center"><i>Loading . . . </i></h5></td></tr>';
    var nothing = '<tr><td colspan="20"><h5 class="text-center"><i>Tidak ada data !</i></h5></td></tr>';
    $(document).find('#data-tarif').load().html(loading);
    var url_control = base_url+"nilai/get_nilai_harian";
