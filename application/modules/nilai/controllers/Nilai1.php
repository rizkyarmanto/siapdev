...
class Nilai extends CI_Controller {
    ...
    function get_tarif_limit() {
        ...
        if($id_ta == '' || $id_jenjang == '' || $id_kelas == '' || $urutan == '') {
            ...
            //$whr = array('id_ta' => $id_ta, 'id_jenjang' => $id_jenjang, 'tingkat' => $id_kelas, 'urutan_kelas' => $urutan);
                            ...
                            $getsis = $get_vsiswa->result();
                                ...
                                foreach($getsis as $gs) {
                                    ...
                                    '<tr>
                                        ...
                                        <td class="text-center"><input type="text" name="uts_tulis[]" class="form-control text-center" /></td>
                                        <td class="text-center"><input type="text" name="uts_praktek[]" class="form-control text-center" /></td>
                                    </tr>
                                        ';
                                $no++;
                                }
    ...
    function get_nilai_harian() {
        ...
        if($id_ta == '' || $id_jenjang == '' || $id_kelas == '' || $urutan == '') {
            ...
            $whr = array('id_ta' => $id_ta, 'id_jenjang' => $id_jenjang, 'tingkat' => $id_kelas, 'urutan_kelas' => $urutan);
            //$whr = array('id_ta' => $id_ta);
            $get_nilai_harian = $this->M_transaksi->get_data_nilai_harian($whr);
            $jml_nilai_cari = $get_nilai_harian->num_rows();
            
            if($jml_nilai_cari > 0){
                $get_vsiswa = $this->M_transaksi->get_data_nilai_harian($whr);
            }else {
                $get_vsiswa = $this->M_transaksi->get_v_siswa($whr); 
            }
            //$get_vsiswa = $this->M_transaksi->get_v_siswa($whr);
