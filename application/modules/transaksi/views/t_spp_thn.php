<form id="form-transaksi" action="<?php echo base_url('transaksi/input_transaksi_limit')?>" method="post"> 
  ...
  <div class="container">
    ...
    <input type="hidden" value="3" name="id_tipe_transaksi">
    ...
    <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-lg-offset-1 col-sm-4">
            ...
            <div id="data-img" style="display:none">
              <!-- Load image here -->
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      <thead>
                        <tr class="danger">
                          ...
                          <th style="width:10%" class="text-center">Tahun Ke</th>
                          <th style="width:20%" class="text-center">Tarif</th>
                          <th style="width:20%" class="text-center">Nominal</th>
                          <th style="width:20%" class="text-center">Keringanan</th>
