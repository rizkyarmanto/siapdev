<form id="form-transaksi" action="<?php echo base_url('transaksi/input_transaksi_cu')?>" method="post"> 
  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
  <div class="container">
    <!-- Content Header (Page header) -->
    <input type="hidden" value="4" name="id_tipe_transaksi">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>transaksi"><?php echo $menu?></a></li>
          ...
          <div class="col-lg-3 col-lg-offset-1 col-sm-4 nav-tabs-custom">
            ...
            <div id="data-qr" style="display:block;">
              <div class="callout callout-success">
                ...
                <p>Masukan No. Induk Siswa pada form dibawah ini</p>
              </div>
              <!--
            ...
            <div class="box box-primary">
              ...
              <div class="box-footer">
                <div class="pull-right">
                  ...
                  <button type="button" onclick="read('C0001')" class="btn btn-flat btn-default">Test Manual</button>
                </div>
              </div>
            </div>
          </div>
  ...
  $.ajax({
    ...
    success: function(response) {
      if(response == 'null') {
        ...
        //swal('Berhasil !', 'NIS siswa yaitu '+nis, 'success');
...
function get_tarif(nis) {
  var loading = '<tr><td colspan="8"><h5 class="text-center"><i>Loading . . . </i></h5></td></tr>';
  var nothing = '<tr><td colspan="8"><h5 class="text-center"><i>Tidak ada data !</i></h5></td></tr>';
  $(document).find('#data-tarif').load().html(loading);
  var url_control = base_url+"transaksi/get_tarif_cu";
