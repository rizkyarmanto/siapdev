...
<div class="container">
  <input type="hidden" id="paramCtrl" value="jenis_keringanan">
  <input type="hidden" class="reset" data-aktif="0">
  <!-- Content Header (Page header) -->
  <input type="hidden" id="paramCtrl" value="gelombang_pend">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            <div class="pull-right">
              <button type="button" class="btn btn-primary btn-sm" onClick="add();" data-toggle="tooltip" 
              title="Tambah" data-original-title="Tambah">
                ...
                <thead>
                  <tr class="bgColorCustom">
                    ...
                    <?php foreach($list_jenjang as $lj){?>
                        <th class="text-center"><?php echo $lj['jenjang']?></th>
                    <?php } ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-success">
        ...
        <h4 class="modal-title">Jenis Keringanan</h4>
      </div>
      <div class="modal-body">
        <form action="#" class="formModal form-horizontal">
            <input type="hidden" name="id_keringanan">
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Keringanan</label>
                <div class="col-md-9">
                    <input name="keringanan" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select name="id_tipe_transaksi" onkeypress="return enterScript(event)" class="form-control">
                      ...
                      <?php } ?>
                      <!-- <option selected="true">check</option> -->
                    </select>
                </div>
            </div>
        </form>
...
<div id="myModalNilai" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header btn-success">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><span id="mdl-title"></span></h4>
      </div>
      <div class="modal-body col-lg-12">
        <div class="callout callout-info">
          <h4><i class="icon fa fa-info"></i> Info </h4>
          <p>Data yang sudah dihapus tidak dapat direstore kembali.</p>
        </div>

        <div class="form-horizontal">
            <div class="row form-group">
              <label class="control-label col-md-2" style="text-align:left;">Filter by Tingkat</label>
              <div class="col-md-4">
                <select onkeypress="return enterScript(event)" class="form-control input-medium filterData" data-column="tingkat">
                      <option value="">All</option>
                  <?php foreach ($list_tingkat as $lj) { ?>
                      <option value="<?php echo $lj['tingkat'];?>"><?php echo $lj['tingkat'];?></option>
                  <?php } ?>
                </select>
              </div>
              <label class="control-label col-md-2" style="text-align:left;">Filter by Jurusan</label>
              <div class="col-md-4">
                <select onkeypress="return enterScript(event)" class="form-control input-medium filterData" data-column="id_jurusan">
                      <option value="">All</option>
                  <?php foreach ($list_jurusan as $lj) { ?>
                      <option value="<?php echo $lj['id_jurusan'];?>"><?php echo $lj['jurusan'];?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            <div class="col-lg-12 row form-group">
              <!-- <a class=" text-success-600; float-left;" ><i class="fa fa-plus"></i></a> -->
              <a class="addNilai float-left btn btn-primary" href="javascript:;">
                <i class="fa fa-plus"></i>&nbsp;Tambah
              </a>
            </div>
        </div>

        <form id="formNilai" method="post" action="#">
...
<script type="text/javascript">
    ...
    function dataTables_MD(paramCtrlN, id, idTipeTransaksi) {
    ...
    function showNilai(e, idTipeTransaksi) {
        var id      = $(e).data("id");
        paramId     = $(e).attr("data-filterId");
        paramColumn = $(e).attr("data-filterColumn");
        var keringanan = $(e).data("keringanan");
        var jenjang = $(e).data("jenjang");
        // filterId    = undefined;
        // filterColumn= undefined;        
        dataTables_MD(paramCtrl, id, idTipeTransaksi);
        $('#myModalNilai').modal('show');
        $('#mdl-title').html('Keringanan '+jenjang+' kategori '+keringanan);
    }
