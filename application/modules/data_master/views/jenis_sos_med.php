...
<div class="container">
  ...
  <input type="hidden" id="paramCtrl" value="jenis_sosmed">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            <div class="pull-right">
              ...
              data-toggle="tooltip" title="Tambah" data-original-title="Tambah">
...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header btn-success">
      ...
      <h4 class="modal-title">Jenis Sosmed</h4>
    </div>
    <div class="modal-body">
      <form action="#" class="formModal form-horizontal">
          <input type="hidden" name="id_jenis_sosmed">
          <div class="form-group">
              <label class="control-label col-md-3" style="text-align:left;">Jenis</label>
              <div class="col-md-9">
                  <input name="jenis" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
              </div>
          </div>
      </form>
    </div>
