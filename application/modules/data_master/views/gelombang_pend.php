  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-success">
        ...
        <h4 class="modal-title">Gelombang</h4>
      </div>
      <div class="modal-body">
        <form action="#" class="formModal form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input name="gelombang" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tanggal Mulai</label>
                <div class="col-md-9">
                    <input name="tgl_mulai" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium myDate" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tanggal Selesai</label>
                <div class="col-md-9">
                    <input name="tgl_selesai" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium myDate" size="16" type="text" value="">
                </div>
            </div>
        </form>
      </div>
