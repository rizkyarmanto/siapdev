...
<div class="container">
  ...
  <input type="hidden" id="paramCtrl" value="jurusan">
      ...
      <div class="modal-body">
        <form action="#" class="formModal form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input name="jurusan" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Akronim</label>
                <div class="col-md-9">
                    <input  name="akronim" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
                </div>
            </div>
        </form>
      </div>
        ...
        $.ajax({
            ...
            success: function(data)
            {
              if (paramCtrl == 'gelombang_pend') {
                ...
                $('input[name="akronim"]').val(data.akronim); 
                $('#myModal').modal('show'); // show bootstrap modal
