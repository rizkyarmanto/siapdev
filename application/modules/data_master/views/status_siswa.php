...
<div class="container">
  ...
  <input type="hidden" id="paramCtrl" value="siswa_status">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-success">
        ...
        <h4 class="modal-title">Status Siswa</h4>
      </div>
      <div class="modal-body">
        <form action="#" class="formModal form-horizontal">
            <input type="hidden" name="id_siswa_status">
            <div class="form-group">
                <label class="control-label col-md-3 field" style="text-align:left;">Status</label>
                <div class="col-md-9">
                    <input name="status" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
                </div>
            </div>
        </form>
      </div>
