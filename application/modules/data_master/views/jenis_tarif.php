...
<div class="container">
  ...
  <input type="hidden" id="paramCtrl" value="jenis_tarif">
      ...
      <div class="col-lg-10 col-lg-offset-1 col-sm-12">
        <div class="box box-warning">
          <div class="box-header">
            <h3 class="box-title">List Nama Tarif</h3>
          ...
          <div class="box-body">
            <div class="row form-group">
              <div class="col-lg-12">
                <table class="table table-bordered table-striped" style="background-color: #00c0ef30;"  id="datatables-ss">
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            <div class="pull-right">
              <button type="button" class="btn btn-primary btn-sm addNilai" data-toggle="tooltip" title="Tambah" data-original-title="Tambah">
                <i class="glyphicon glyphicon-plus"></i></button>
                &nbsp;
          ...
          <div class="box-body">
            <div class="col-lg-12" style="padding:0; margin-bottom: 1%">
              <div class="form-horizontal">
                <div class="row form-group">
                  <div class="col-lg-4">
                    <label class="control-label col-md-4" style="text-align:left;">Tahun Ajaran</label>
                    <div class="col-md-8">
                      <select onkeypress="return enterScript(event)" class="form-control input-medium filterData" data-column="id_ta">
                        ...
                        <?php foreach ($list_ta as $lta) { ?>
                          <option value="<?php echo $lta['id_ta'];?>"><?php echo $lta['teks_ta'];?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <label class="control-label col-md-4" style="text-align:left;">Jurusan</label>
                    <div class="col-md-8">
                  ...
                  <div class="col-lg-4">
                    <label class="control-label col-md-4" style="text-align:left;">Gelombang</label>
                    <div class="col-md-8">
                      <select onkeypress="return enterScript(event)" class="form-control input-medium filterData" data-column="id_gelombang">
                            <option value="">All</option>
                        <?php foreach ($list_gelombang as $lge) { ?>
                          <option value="<?php echo $lge['id_gelombang'];?>"><?php echo $lge['gelombang'];?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
              ...
              <div class="form-horizontal">
                <div class="row form-group">
                  <div class="col-lg-4">
                    <label class="control-label col-md-4" style="text-align:left;">Jenjang</label>
                    <div class="col-md-8">
                  ...
                  <div class="col-lg-4">
                    <label class="control-label col-md-4" style="text-align:left;">Tingkat</label>
                    <div class="col-md-8">
                  ...
                  <div class="col-lg-4">
                    <label class="control-label col-md-4" style="text-align:left;">Nama Tarif</label>
                    <div class="col-md-8">
                      <select onkeypress="return enterScript(event)" class="form-control input-medium filterData" data-column="id_tarif">
                            <option value="">All</option>
                        <?php foreach ($list_tarif as $lnt) { ?>
                          <option value="<?php echo $lnt['id_tarif'];?>"><?php echo $lnt['nama_tarif'];?></option>
                      <?php } ?>
                      </select>
                    </div>
                  </div>
            ...
            <div class="col-lg-12" style="overflow-x: auto; padding:0;">
              <table class="table table-bordered table-striped" style="background-color: #00c0ef30;" id="datatables-ssMD" width="100%">
                <thead class="bgColorCustom">
                  <tr>
                    <th>No</th>
                    <th>Tahun Ajaran</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-success">
        ...
        <h4 class="modal-title">Jenis Tarif</h4>
      </div>
      <div class="modal-body">
        <form action="#" class="formModal form-horizontal">
            <input type="hidden" name="id_tarif">
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Nama Tarif</label>
                <div class="col-md-9">
                    <input name="nama_tarif" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tipe Transaksi</label>
                <div class="col-md-9">
                    <select name="id_tipe_transaksi" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_tipe_transaksi as $ltp) { ?>
                          <option value="<?php echo $ltp['id_tipe_transaksi'];?>"><?php echo $ltp['tipe_transaksi'];?></option>
                      <?php } ?>
                    </select>
                </div>
            </div>
...
<div id="myModalNilai" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-success">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
        <form action="#" id="formNilai" class="form-horizontal">
            <input type="hidden" name="id_tarif_nilai">
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Nama Tarif</label>
                <div class="col-md-9">
                    <select name="id_tarif" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_tarif as $lnt) { ?>
                          <option value="<?php echo $lnt['id_tarif'];?>"><?php echo $lnt['nama_tarif'];?></option>
                      <?php } ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select name="id_ta" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_ta as $lta) { ?>
                          <option value="<?php echo $lta['id_ta'];?>"><?php echo $lta['teks_ta'];?></option>
                      <?php } ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select name="id_jenjang" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_jenjang as $lje) { ?>
                          <option value="<?php echo $lje['id_jenjang'];?>"><?php echo $lje['jenjang'];?></option>
                      <?php } ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select name="id_jurusan" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_jurusan as $lju) { ?>
                          <option value="<?php echo $lju['id_jurusan'];?>"><?php echo $lju['jurusan'];?></option>
                      <?php } ?>
                    </select>
            ...
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tingkat</label>
                <div class="col-md-9">
                    <select name="tingkat" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_tingkat as $lti) { ?>
                          <option value="<?php echo $lti['tingkat'];?>"><?php echo $lti['tingkat'];?></option>
                      <?php } ?>
                    </select>
            ...
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Gelombang</label>
                <div class="col-md-9">
                    <select name="id_gelombang" onkeypress="return enterScript(event)" class="form-control">
                      <?php foreach ($list_gelombang as $lge) { ?>
                          <option value="<?php echo $lge['id_gelombang'];?>"><?php echo $lge['gelombang'];?></option>
                      <?php } ?>
                    </select>
            ...
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Nominal</label>
                <div class="col-md-9">
                    <input name="nominal" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium" size="16" type="text" value="">
                </div>
            </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
        <button type="button" class="saveNilai btn btn-success">Save</button>
      </div>
    </div>
  </div>
</div>

<div id="myModalNilaiEdit" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header btn-success">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      ...
      <div class="modal-body">
        <form action="#" id="formNilaiEdit" class="form-horizontal">
            <input type="hidden" name="id_tarif_nilai">
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Nama Tarif</label>
                <div class="col-md-9">
                    <input class="nama_tarif form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tahun Ajaran</label>
                <div class="col-md-9">
                    <input class="teks_ta form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Jenjang</label>
                <div class="col-md-9">
                    <input class="jenjang form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Jurusan</label>
                <div class="col-md-9">
                    <input class="jurusan form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tingkat</label>
                <div class="col-md-9">
                    <input class="tingkat form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Gelombang</label>
                <div class="col-md-9">
                    <input class="gelombang form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>                        
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Nominal</label>
...
<script type="text/javascript">
    ...
    $(document).on("change", ".filterData", function() {
        ...
        filterId_tingkat  = $('select[data-column="tingkat"]').val();
        filterId_gelombang  = $('select[data-column="id_gelombang"]').val();
        filterId_tarif    = $('select[data-column="id_tarif"]').val();

        console.log(filterId_ta+" "+filterId_jenjang+" "+filterId_jurusan+" "+filterId_tingkat+" "+filterId_gelombang+" "+filterId_tarif);
        // table_MD.ajax.url("<?php echo base_url('data_master/show_"+paramCtrl+"_nilai')?>").load();
    ...
    $(document).on("click", ".editNilai", function() {
        ...
        var id    = $(this).attr("data-id");
        $('#myModalNilaiEdit').find('#formNilaiEdit')[0].reset(); // reset form on modals
        // $('.form-group').removeClass('has-error'); // clear error class
        // $('.help-block').empty(); // clear error string

        $.ajax({
            url : "<?php echo base_url('data_master/"+paramCtrl+"_nilai_detail');?>/"+id,
            type: "POST",
            dataType : "JSON",
            success: function(data) {
              console.log(data);
              $('#myModalNilaiEdit').find('input[name="id_tarif_nilai"]').val(id);
              $('#myModalNilaiEdit').find('.nama_tarif').val(data.nama_tarif);
              $('#myModalNilaiEdit').find('.teks_ta').val(data.teks_ta);
              $('#myModalNilaiEdit').find('.jenjang').val(data.jenjang);
              $('#myModalNilaiEdit').find('.jurusan').val(data.jurusan);
              $('#myModalNilaiEdit').find('.tingkat').val(data.tingkat);
              $('#myModalNilaiEdit').find('.gelombang').val(data.gelombang);
              $('#myModalNilaiEdit').find('input[name="nominal"]').val(data.nominal);

              $('#myModalNilaiEdit').modal('show'); // show bootstrap modal
        ...
        $('#myModalNilaiEdit').find('input[name="nominal"]').focus();
    });
