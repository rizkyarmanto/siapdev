      ...
      <div class="modal-body">
        <form action="#" id="formModal" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Nama Siswa</label>
                <div class="col-md-9">
                    <input class="nama form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">NIS</label>
                <div class="col-md-9">
                    <input class="nis form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">NISN</label>
                <div class="col-md-9">
                    <input class="nisn form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Agama</label>
                <div class="col-md-9">
                    <input class="agama form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Kelamin</label>
                <div class="col-md-9">
                    <input class="kelamin form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">TTL</label>
                <div class="col-md-9">
                    <input class="ttl form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Anak ke</label>
                <div class="col-md-9">
                    <input class="anak_ke form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Asal Sekolah</label>
                <div class="col-md-9">
                    <input class="asal_sekolah form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 ortu_label" style="text-align:right;">Nama Ayah</label>
                <div class="col-md-9">
                    <input class="ortu_ayah form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>          
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Nama Ibu</label>
                <div class="col-md-9">
                    <input class="ortu_ibu form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 ortu_no_telp_label" style="text-align:right;">No. Telp Orang Tua</label>
                <div class="col-md-9">
                    <input class="ortu_no_telp form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:right;">Keterangan</label>
                <div class="col-md-9">
                    <textarea class="keterangan form-control form-control-inline input-medium" size="16" type="text" value="" readonly></textarea>
                </div>
            </div>
        </form>
      </div>
      ...
      table_MD    = $("#datatables-ssMD").DataTable({ 
          ...
          "ajax": {
              ...
              "data": function(param) {
                  ...
                  param.urutan_kelas  = filterUrutan_kelas
              }
          },
