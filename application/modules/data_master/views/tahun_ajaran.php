...
<div class="container">
  ...
  <input type="hidden" id="paramCtrl" value="tahun_ajaran">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="#" class="formModal form-horizontal">
            ...
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tahun Mulai</label>
                <div class="col-md-9">
                    <input name="tahun_mulai" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Tahun Selesai</label>
                <div class="col-md-9">
                    <input name="tahun_selesai" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="text-align:left;">Persen Batal</label>
                <div class="col-md-9">
                    <input name="percent_batal" onkeypress="return enterScript(event)" class="form-control form-control-inline input-medium field" size="16" type="text" value="">
                </div>
            </div>
        </form>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" onClick="saving(this)" id="simpan" class="btn btn-success">Save</button>
      </div>
    </div>
  </div>
</div>
