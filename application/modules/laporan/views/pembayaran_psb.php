        ...
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title pull-left">
              List Pembayaran Siswa Baru Tahun <?php echo date('Y')?>
            </h3>
            <div class="pull-right">
               <button type="button" class="btn btn-primary btn-sm cetakPembayaran" data-toggle="tooltip" title="Cetak" data-original-title="Cetak">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      table_MD    = $("#datatables-ssMD").DataTable({ 
          ...
          "ajax": {
              "url": "<?php echo base_url('data_master/show_pembayaran_psb_"+paramCtrl+"')?>",
              "type": "POST",
              "data": function(param) {
    ...
    $(document).on("click", ".cetakPembayaran", function() {
        window.open('laporan/pembayaran_print', '_blank', 'location=yes,height=570,width=800,scrollbars=yes,status=yes');
    });
</script>
